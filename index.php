<?php 
// INSERT INTO `notes` (`srno`, `title`, `description`, `tstamp`) VALUES (NULL, 'Buy Books', 'please buy books form store', current_timestamp());
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this note!")) {
                    ...
                    // create a form and use user post request to submit a form
                }
                else {
                    console.log("no");
